...
echo ""
sudo cp $HOME/endeavour-dots/sddm/sddm.conf /etc/sddm.conf.d/
sudo cp $HOME/endeavour-dots/sddm/sddm.conf /etc/
echo "File /etc/sddm.conf updated."
echo ""
cp ~/endeavour-dots/default.png ~/.cache/current-wallpaper.png
echo ""
...
echo ""
echo ""
sudo cp ~/endeavour-dots/sddm/theme.conf /usr/share/sddm/themes/Sugar-Candy/
